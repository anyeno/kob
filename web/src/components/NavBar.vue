    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <!-- <a class="nav-link" href="/ranklist/">排行榜</a> -->
            <router-link :class="route_name == 'rpost' ? 'nav-link active' : 'nav-link'" :to="{name:'post'}">发帖</router-link>
          </li>
        </ul>
        ...
        <ul class="navbar-nav" v-if="!$store.state.user.is_login">
          ...
          <li class="nav-item">
            <router-link :class="route_name == 'register' ? 'nav-link active' : 'nav-link'" :to="{name:'register'}">注册</router-link>
          </li>
        </ul>  
