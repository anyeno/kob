            ...
            <div class="col-9">
                <div class="card" style="margin-top:20px">
                    <div class="card-header">
                        ...
                        >创建Bot</button>
                        <!-- data-bs-toggle="modal" data-bs-target="#add-bot-btn"  是指触发模态框 -->
                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input v-model="botadd.description" type="text" class="form-control" id="add-bot-description" placeholder="请输入Bot简介">
                                    </div>
                                    <div class="mb-3">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover">
                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-footer">
                                    <div class="error_msg">{{ bot.error_message }}</div>
...
export default {
    ...
    setup() {
        ...
        const  refresh_bots = ()=>{
            $.ajax({
                url:"https://app2409.acapp.acwing.com.cn/api/user/bot/getlist/",
                type:"get",
                headers: {
        ...
        const add_bot = () => {
            botadd.error_msg = "";
            $.ajax({
                url:"https://app2409.acapp.acwing.com.cn/api/user/bot/add/",
                type:"post",
                data:{
                    title: botadd.title,
                ...
                success(resp) {
                    if(resp.error_message === "success") {
                        ...
                        botadd.error_msg = resp.error_message;
                    }
                }
            })
        }
        ...
        const update_bot = (bot) => {
            botadd.error_msg = "";
            $.ajax({
                url:"https://app2409.acapp.acwing.com.cn/api/user/bot/update/",
                type:"post",
                data:{
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                 url:"https://app2409.acapp.acwing.com.cn/api/user/bot/remove/",
                type:"post",
                data:{
                    bot_id: bot.id,
                },
